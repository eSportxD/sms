...
error_reporting(0);
$get_id=$_GET['id'];
$file=file_get_contents("https://temp-numbers.xyz/admin/API/get_lsit.php?no=$get_id");
if($file==""){
...
?>            
                    ...
                    <div class="card">
                        <div class="card-body text-center">
                            ...
                            <div class="card-text">
                                <p class="p-0 m-0 font-weight-bold"><?php echo $stand->ToNumber; ?></p>
                                <p class="p-0 m-0 small"><?php echo $stand->realtime; ?></p>
                                             <a class="btn btn-primary m-2" href='sms.php?id=<?php echo $stand->ToNumber; ?>&country=<?php echo $get_id; ?>'>Check Number</a>
